--// Full Brainrot Panel + Auto Joiner - Para Sirius
...
screenGui.Name = "FullStealerPanel"
...
title.Text = "🧠 FULL BRAINROT PANEL"
...
local yPos = 70
local function addToggle(name, defaultText, callback)
...
-- Auto Steal
addToggle("Auto Steal", "🔓 Auto Steal: OFF", function(btn)
    stealEnabled = not stealEnabled
    btn.Text = "🔓 Auto Steal: " .. (stealEnabled and "ON ✅" or "OFF")
    btn.BackgroundColor3 = stealEnabled and Color3.fromRGB(0, 180, 0) or Color3.fromRGB(30, 30, 35)
end)

-- Auto Cloner
addToggle("Auto Cloner", "♻️ Auto Cloner: OFF", function(btn)
    cloneEnabled = not cloneEnabled
    btn.Text = "♻️ Auto Cloner: " .. (cloneEnabled and "ON ✅" or "OFF")
    btn.BackgroundColor3 = cloneEnabled and Color3.fromRGB(0, 180, 0) or Color3.fromRGB(30, 30, 35)
end)

-- Auto Farm
addToggle("Auto Farm", "🌾 Auto Farm: OFF", function(btn)
    farmEnabled = not farmEnabled
    btn.Text = "🌾 Auto Farm: " .. (farmEnabled and
title: Windows
